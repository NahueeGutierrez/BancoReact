function InfoTyc() {
    return (  
        ...
        <div className="info">
            ...
            <p>Estos términos y condiciones se rigen por las leyes del [país/jurisdicción]. Cualquier disputa estará sujeta a la jurisdicción de los tribunales de [ciudad].</p>
